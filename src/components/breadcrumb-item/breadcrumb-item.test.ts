...
import type OneXBreadcrumbItem from './breadcrumb-item';

describe('<onex-breadcrumb-item>', () => {
  let el: OneXBreadcrumbItem;

  describe('when not provided a href attribute', () => {
    before(async () => {
      el = await fixture<OnexBreadcrumbItem>(html` <onex-breadcrumb-item>Home</onex-breadcrumb-item> `);
    });
  ...
  describe('when provided a href attribute', () => {
    describe('and no target', () => {
      before(async () => {
        el = await fixture<OnexBreadcrumbItem>(html`
          <onex-breadcrumb-item href="https://jsonplaceholder.typicode.com/">Home</onex-breadcrumb-item>
        `);
      });
    ...
    describe('and target, without rel', () => {
      before(async () => {
        el = await fixture<OnexBreadcrumbItem>(html`
          <onex-breadcrumb-item href="https://jsonplaceholder.typicode.com/" target="_blank">Help</onex-breadcrumb-item>
        `);
      });
    ...
    describe('and target, with rel', () => {
      before(async () => {
        el = await fixture<OnexBreadcrumbItem>(html`
          <onex-breadcrumb-item href="https://jsonplaceholder.typicode.com/" target="_blank" rel="alternate"
            >Help</onex-breadcrumb-item
          >
        `);
      });
