...
import type OneXDialog from './dialog';

describe('<onex-dialog>', () => {
  it('should be visible with the open attribute', async () => {
    const el = await fixture<OnexDialog>(html`
      <onex-dialog open>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</onex-dialog>
    `);
  ...
  it('should not be visible without the open attribute', async () => {
    const el = await fixture<OnexDialog>(
      html` <onex-dialog>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</onex-dialog> `
    );
    const base = el.shadowRoot!.querySelector<HTMLElement>('[part~="base"]')!;
  ...
  it('should emit onex-show and onex-after-show when calling show()', async () => {
    const el = await fixture<OnexDialog>(html`
      <onex-dialog>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</onex-dialog>
    `);
    const base = el.shadowRoot!.querySelector<HTMLElement>('[part~="base"]')!;
  ...
  it('should allow initial focus to be set', async () => {
    const el = await fixture<OnexDialog>(html` <onex-dialog><input /></onex-dialog> `);
  ...
  it('should close when pressing Escape', async () => {
    const el = await fixture<OnexDialog>(html` <onex-dialog open></onex-dialog> `);
    const hideHandler = sinon.spy();
